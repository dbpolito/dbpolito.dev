        ...
        <nav x-data="{ open: false }" @keydown.window.escape="open = false" class="bg-gray-800">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    <div class="flex-grow">
                        <h1>
                            <a href="{{ localized_route('posts') }}" class="flex text-white text-lg leading-loose">
                                <img class="h-8 mr-2" src="https://avatars2.githubusercontent.com/u/347400?s=460&v=4"
                                    alt="">
                                Daniel Polito
                            </a>
                        </h1>
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline">
                            <a class="p-2" href="https://github.com/dbpolito" target="_blank">
                                <svg class="h-5 w-5 inline-block text-white fill-current opacity-25 hover:opacity-75"
                            ...
                            <a href="{{ localized_route($item->route) }}"
                                class="ml-2 px-3 py-2 rounded-md text-sm font-medium {{ $item->is_active ? 'text-white bg-gray-900' : 'text-gray-300 hover:text-white hover:bg-gray-700' }} focus:outline-none focus:text-white focus:bg-gray-700">{{ $item->name}}</a>
                            @endforeach
                        </div>
                    </div>
                    <div class="flex">
                        <a class="p-2 {{ $locale !== 'pt_BR' ? 'opacity-25 hover:opacity-50' : '' }}" @if ($locale
                            !=='pt_BR' ) href="{{ $currentUrlForOtherLocale }}" @endif title="Português">
                        ...
                        <a class="p-2 {{ $locale !== 'en' ? 'opacity-25 hover:opacity-50' : '' }}" @if ($locale !=='en'
                            ) href="{{ $currentUrlForOtherLocale }}" @endif title="English">
                            <svg class="h-6 w-6 inline-block" viewBox="0 0 512 512">
                    ...
                    <div class="-mr-2 ml-1 flex md:hidden">
            ...
            <div :class="{'block': open, 'hidden': !open}" class="hidden md:hidden">
                <div class="px-2 pt-2 pb-3 sm:px-3">
                    @foreach ($menu as $item)
                    <a href="{{ localized_route($item->route) }}"
                        class="mt-1 block px-3 py-2 rounded-md text-base font-medium {{ Route::currentRouteNamed($item->route) ? 'text-white bg-gray-900' : 'text-gray-300 hover:text-white hover:bg-gray-700' }} focus:outline-none focus:text-white focus:bg-gray-700">{{ $item->name }}</a>
                    @endforeach
